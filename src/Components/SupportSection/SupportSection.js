...
const SupportSection = () => {
  ...
  return (
    <section className="bg-gray-50 py-24 px-4 lg:px-24 mt-0" data-aos="fade-up">
      <div className="text-center mb-12 animate-fade-in">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
          Our Aim and Aspirations <span className="text-red-500">Aspirations.</span>
        </h2>
        <p className="text-4xl md:text-6xl font-bold text-gray-800 leading-tight">
          Shaping the Future of Boxing <span className="text-red-500"> Excellence, <br /> Empowerment</span> Through Training and Opportunity.
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 lg:gap-10">
        {/* Card 1 */}
        <div className="bg-white p-8 shadow-lg rounded-2xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex flex-col items-start space-y-6 w-full" data-aos="fade-up">
        ...
        {/* Card 2 */}
        <div className="bg-white p-8 shadow-lg rounded-2xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex flex-col items-start space-y-6 w-full" data-aos="fade-up" data-aos-delay="200">
        ...
        {/* Card 3 */}
        <div className="bg-white p-8 shadow-lg rounded-2xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex flex-col items-start space-y-6 w-full" data-aos="fade-up" data-aos-delay="400">
        ...
        {/* Card 4 */}
        <div className="bg-white p-8 shadow-lg rounded-2xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex flex-col items-start space-y-6 w-full" data-aos="fade-up" data-aos-delay="600">

      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 lg:gap-10">
        ...
        <img src={image} alt="Live Classes" className="h-16 w-16 transform transition-transform duration-500 hover:rotate-12" />
          ...
          <div className="text-left">
            ...
            <button className="block py-2 px-6 bg-transparent text-red-500 border border-red-500 rounded-full hover:bg-red-500 hover:text-white transition-colors duration-300 hover:shadow-lg hover:shadow-red-500/50 animate-pulse-on-hover">
              Read more
            </button>
          </div>
        </div>

...
const OurTeam = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-900 via-black to-gray-800 min-h-screen text-white py-16 px-4">
      {/* Header */}
      <div className="text-center mb-12" data-aos="fade-down">
        <h1 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-red-400 mb-4">
        ...
        {initialTeamMembers.map((member, index) => (
          ...
          >
            ...
            <div className="mt-4 text-center">
              <h3 className="text-2xl font-semibold text-red-400">{member.name}</h3>
              <p className="text-gray-300 text-base mb-2">{member.role}</p>
              <span className="bg-gradient-to-r from-red-400 to-red-400 text-black px-3 py-1 rounded-full text-xs absolute top-4 right-4">
                {member.tag}
              </span>
            </div>
          </div>
      ...
      <div className="flex justify-center mt-10" data-aos="fade-up">
        <button
          ...
          className="px-8 py-3 md:px-10 md:py-4 bg-gradient-to-r from-red-400 to-red-400 text-black rounded-full text-lg transition-transform transform hover:scale-110 hover:shadow-lg duration-300"
        >
